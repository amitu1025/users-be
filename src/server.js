...
if (
  ...
  if (
    ...
    mongoose.connect(environmentVariablesConfig.mongoDbConnString, {
...
const initApplication = async () => {
  ...
  const server = new ApolloServer({
    ...
    plugins:
      environmentVariablesConfig.environment === ENVIRONMENT.PRODUCTION
        ? [ApolloServerPluginLandingPageDisabled()]
        : [requestDevLogger, ApolloServerPluginLandingPageGraphQLPlayground()], // Log all querys and their responses. Show playground (do not use in production)
    formatError(error) {
